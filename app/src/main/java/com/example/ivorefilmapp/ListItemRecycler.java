...
public class ListItemRecycler extends RecyclerView.Adapter<ItemRecyclerAdapter.ItemViewHolder>{
    Context context;
    List<CategoryItem> categoryItemList;
    final String token;
    int type;
    public ListItemRecycler(Context context, List<CategoryItem> categoryItemList,String token,int type) {
    ...
    public ItemRecyclerAdapter.ItemViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new ItemRecyclerAdapter.ItemViewHolder(LayoutInflater.from(context).inflate(R.layout.cat_recycler_row_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull ItemRecyclerAdapter.ItemViewHolder holder, final int position) {
